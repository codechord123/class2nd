    ...
    <div className="space-y-3">
      ...
      <Section icon="🏅" title="점수는 어떻게 쌓여요?" tint="bg-indigo-100">
        ...
        <div className="space-y-1.5">
          <Row label="🤝 부서장 평가" pts="점수만큼" desc="부서장이 '내 부서 기준을 잘 지켰나'로 모둠원을 평가한 점수" />
          <Row label="👑 부서장 표" pts="1표 +1점" desc="'오늘의 부서장' 투표에서 받은 표 수만큼" />
          <Row label="🏆 모둠 순위" pts="순위별" desc="선생님이 매긴 모둠 순위 점수 — 모둠원 전원 같이 받아요" />
          <Row label="🐢 독서" pts="1편 +1점" desc="그날 쓴 감상문 편수만큼 — 많이 쓰면 그만큼! (제한 없음)" />
        ...
        <div className="space-y-1.5 rounded-btn border border-indigo-100 bg-indigo-50/60 px-3 py-2.5 text-xs">
          <p>
            ⭐ <b>오늘의 MVP</b>: 총점으로 모둠 1위면 <b>+1점</b>, 학급 전체 1위면 <b>+2점</b>{" "}
            추가! (동점이면 모두 인정)
          </p>
          <p>
      ...
      <Section icon="🐢" title="거북이 독서 마라톤" tint="bg-emerald-100">
        <ul className="list-inside list-disc space-y-1.5">
          <li>
            감상문 <b>1편 = 누적 점수 +1점 + 학급 권수 +1권</b>. 몇 편이든 제한 없이 쓴 만큼
            인정!
          </li>
          <li>
      ...
      <Section icon="🤝" title="모둠과 부서 — 평가는 왜 할까?" tint="bg-orange-100">
        <ul className="list-inside list-disc space-y-1.5">
          ...
          <li>
            <b>부서장 평가</b>는 점수 주기 놀이가 아니라, 부서장으로서{" "}
            <b>"내 부서 기준을 친구가 잘 지켰나"</b>를 보는 거예요. 기준으로 평가해야 공정해요.
          </li>
          <li>
            <b>오늘의 부서장 투표</b>는 모둠원을 가장 친절하게 안내한 부서장에게! 받은 표
            수만큼 점수(+1/표)가 돼요.
          </li>
          <li>
            <b>칭찬</b>은 매일의 미션 — 우리 모둠 <b>전원이 받으면</b> 모둠 전체가 +1점이라,
            서로 챙길수록 이득이에요.
          </li>

    ...
    <div className="space-y-3">
      ...
      <Section icon="🏅" title="점수는 어떻게 쌓여요?" tint="bg-indigo-100">
        ...
        <div className="space-y-1.5">
          <Row label="🤝 부서장 평가" pts="O/X" desc="부서장이 내 부서 O/X 기준으로 평가 — 둘 다 O +1·하나 0·둘 다 X −1. 내 이름이 친구에게 보여요 (억울하면 이의제기!)" />
      ...
      <Section icon="🤝" title="모둠과 부서 — 평가는 왜 할까?" tint="bg-orange-100">
        <ul className="list-inside list-disc space-y-1.5">
          ...
          <li>
            ...
            <b>"내 부서 O/X 기준을 친구가 지켰나"</b>를 사실대로 체크해요 — 둘 다 O면 +1,
            하나면 0, 둘 다 X면 −1. <b>내가 준 평가는 친구에게 실명으로 보여요.</b> 사실과

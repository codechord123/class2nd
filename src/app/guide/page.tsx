    ...
    <div className="space-y-3">
      ...
      <Section icon="🌅" title="하루는 이렇게 흘러가요" tint="bg-brand-weak" defaultOpen>
        <ol className="space-y-2">
          ...
          <Step
            n={2}
            title="저녁 — Team 탭에서 4가지"
            desc="① 부서장 평가(내 부서 기준으로 모둠원 평가) ② 오늘의 부서장 투표 ③ 페어플레이 투표(배려왕) ④ 칭찬 보내기."
          />
          <Step
            n={3}
      ...
      <Section icon="🏅" title="점수는 어떻게 쌓여요?" tint="bg-indigo-100">
        ...
        <div className="space-y-1.5">
          ...
          <Row label="🤝 페어플레이" pts="+1점" desc="'오늘 모둠원을 가장 잘 배려한 친구' 투표 — 모둠 최다 득표자 +1 (개인 점수)" />
          <Row label="📌 할 일 완주" pts="+1점" desc="오늘 할 일 5개(평가·부서장 투표·페어플레이·칭찬·독서 1권)를 다 하면 +1 — 모둠 전원이 다 하면 모둠 점수 +1 더!" />
        ...
        <div className="space-y-1.5 rounded-btn border border-indigo-100 bg-indigo-50/60 px-3 py-2.5 text-xs">
          ...
          <p>
            🔥 <b>미션 연속 보너스 (팀)</b>: 우리 모둠이 칭찬 미션을 학교 오는 날 기준
            연속으로 달성하면 <b>모둠 점수</b>에 매일 보너스 — <b>3일부터 +1</b>, 6일부터
            +2, 9일 +3, 10일 +4! (세션마다 새로 시작)
          </p>
        </div>
      </Section>
      ...
      <Section icon="🏆" title="세션(2주)과 보상" tint="bg-amber-100">
        ...
        <div className="space-y-1.5">
          ...
          <Row label="💰 저축 이자" pts="최대 2" desc="세션이 끝날 때 남아 있는 실버의 10%를 이자로 — 아껴 모은 사람의 보너스!" />
        </div>
      ...
      <Section icon="📝" title="게시판·투표로 학급 바꾸기" tint="bg-sky-100">
        <ul className="list-inside list-disc space-y-1.5">
          ...
          <li>
            <b>📜 법률 탭</b>: 우리 부서 법을 직접 만들어 올려요 — 채택되면 헌법 탭의 그
            부서 법이 돼요. 부서 칩을 누르면 부서별로 어떤 법이 올라와 통과(채택)됐는지
            한눈에 볼 수 있어요.
          </li>
          <li>
            <b>🕵️ 숨은기여 탭</b>: 티 안 나게 좋은 일을 한 친구를 추천해요 (건의에서 독립).
            친구들이 👍로 공감하면 선생님이 금요일에 실버로 보상해요.
          </li>
          <li>
            <b>투표 탭</b>: 학급 규칙·행사를 우리 손으로 정해요. 결과는 <b>내가 투표한
            뒤에</b> 보여요 — 친구 따라 말고 내 생각대로! 투표로 정한 건 헌법 탭에 기록돼요.
          </li>
          <li>
      ...
      <Section icon="❓" title="자주 묻는 질문" tint="bg-ink-100">
        <div className="space-y-2">
          ...
          <Faq
            q="'저장 권한이 없어요'라고 떠요!"
            a="기기 인증이 풀린 거예요 — 로그아웃했다가 내 번호로 다시 로그인하면 바로 풀려요. 🔑"
          />
          <Faq
            q="쓰다가 인터넷이 끊기면 글이 날아가요?"
            a="아니요! 감상문은 '임시저장'을 눌러두면 안전하고, 건의 글은 쓰던 내용이 이 기기에 자동으로 남아 있어요. 와이파이가 돌아오면 이어서 등록하면 돼요."
          />
          <Faq
            q="앱처럼 쓰고 싶어요."
            a="브라우저 메뉴에서 '홈 화면에 추가'를 누르면 아이콘이 생기고, 주소창 없는 앱처럼 열려요! 📱"
          />
          <Faq
            q="더 궁금한 게 있어요!"
            a={
